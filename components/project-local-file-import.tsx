...
type ProjectLocalFileImportProps = {
  accept: string;
...
export function ProjectLocalFileImport({
  accept,
  extension,
  fileLabel,
  maxLength,
  ...
  function confirmImport() {
    ...
    setState({
      kind: "success",
      message: `${fileName} imported locally. Normal project saving now applies.`,
    });
  }
  ...
  function cancelImport() {
    ...
    setState({
      kind: "success",
      message: "Import cancelled. Your project file was not changed.",
    });
  }

  return (
    <div className="project-local-import">
      <input
        ref={inputRef}
        type="file"
        accept={accept}
      ...
      <button
        type="button"
        className="project-local-import-trigger"
      ...
      {state.kind !== "idle" ? (
        <p
          className={
            state.kind === "error"
              ? "project-local-import-message is-error"
              : "project-local-import-message"
          }
          role="status"
          aria-live="polite"
        >
      ...
      {pendingImport ? (
        <div
          className="project-local-import-confirmation"
          role="group"
        ...
        >
          <div>
            ...
            <p>
              This replaces the current editor text. Your saved review stays
              unchanged until you submit the imported source.
            </p>
          </div>
          <div className="project-local-import-actions">
